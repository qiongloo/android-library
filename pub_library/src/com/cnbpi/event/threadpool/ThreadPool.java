package com.cnbpi.event.threadpool;
...
public class ThreadPool
{
	...
	private static ThreadPoolExecutor hideService;

    private static ThreadPoolExecutor iconService;

    private static ThreadPoolExecutor galleryService;

    private static ThreadPoolExecutor textService;

    private static ThreadPoolExecutor viewService;

    private static ThreadPoolExecutor newFixedThreadPool(int nThreads, int priority)
    {
        return new ThreadPoolExecutor(nThreads, nThreads, 0L,
            TimeUnit.MILLISECONDS, new BlockingStack<Runnable>(),
            new SkyThreadFactory(priority), new RejectedExecutionHandler() {
    ...
    public static ThreadPoolExecutor newCachedThreadPool(int priority)
    {
        return new ThreadPoolExecutor(2, 3, 60L,
    ...
    public static void submitText(Runnable runnable)
    {
        ...
        if (textService == null)
        {
            textService = newFixedThreadPool(3, 5);
        }
    ...
    public static void submitHideTask(Runnable runnable)
    {
        if (hideService == null )
        {
        	hideService = newFixedThreadPool(2, 5);
        }
        hideService.submit(runnable);
    }
...
//        {
//            iconService =
//                HttpUtil.is2GNetEnv() ? newFixedThreadPool(4, 4)
//                    : newFixedThreadPool(4, 4);
//        }
...
//        {
//            galleryService =
//                HttpUtil.is2GNetEnv() ? newFixedThreadPool(1, 4)
//                    : newFixedThreadPool(2, 4);
//        }
//        galleryService.execute(runnable);
//    }
    ...
    public static void destory()
    {
        ...
        if (hideService != null)
        {
        	hideService.shutdownNow();
        	hideService = null;
        }

        if (galleryService != null)
        {
            galleryService.shutdownNow();
            galleryService = null;
        }
